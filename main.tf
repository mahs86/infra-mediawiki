...
terraform {
  backend "azurerm" {
    ...
    resource_group_name  = "rg-tw-dev-eaus2-01"
    storage_account_name = "satfstateblobeaus2" # Storage account used for backend
    container_name       = "terraformstate"
    key                  = "medwiki-dev.tfstate" # Terraform State file
  }
}
